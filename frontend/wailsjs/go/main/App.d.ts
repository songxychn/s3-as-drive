...
export function DeleteFile(arg1:number):Promise<types.Result>;

export function DownloadFile(arg1:number):Promise<types.Result>;

export function GetConfig():Promise<types.Result>;

export function GetFileList(arg1:string):Promise<types.Result>;

export function GetShareUrl(arg1:number,arg2:number):Promise<types.Result>;
